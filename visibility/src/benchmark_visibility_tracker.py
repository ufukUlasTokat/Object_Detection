...
def main():
    frame_folder = "../data/VisDrone2019-SOT-val/sequences/uav0000024_00000_s"  # folder containing video frames as .jpg
    ...
    fps = 30  # default FPS if reading from image sequence
    ...
    print(f"Average Flow Coherence: {sum_flow / proc_count * 100:.1f}%")
    print(f"Average Keypoint Ratio: {sum_kp / proc_count * 100:.1f}%")
    print(f"Average Path Consistency: {sum_path / proc_count * 100:.1f}%")
